...
* The base URL for the API endpoints listed in this document is: [**https://papi.asterdex-testnet.com**](https://papi.asterdex-testnet.com)  
...
```javascript
{
 "s": "BTC_UP_DOWN_5M_1778483280_YUSDT",   // symbol
